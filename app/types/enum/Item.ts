...
export enum Item {
  ...
  FIGHTINIUM_Z = "FIGHTINIUM_Z",
  PSYCHIUM_Z = "PSYCHIUM_Z",
  DARKINIUM_Z = "DARKINIUM_Z",
  STEELIUM_Z = "STEELIUM_Z",
  GROUNDIUM_Z = "GROUNDIUM_Z",
  POISONIUM_Z = "POISONIUM_Z",
  DRAGONIUM_Z = "DRAGONIUM_Z",
  FIELDIUM_Z = "FIELDIUM_Z",
  MONSTERIUM_Z = "MONSTERIUM_Z",
  HUMANIUM_Z = "HUMANIUM_Z",
  AQUATINIUM_Z = "AQUATINIUM_Z",
  BUGINIUM_Z = "BUGINIUM_Z",
  FLYINIUM_Z = "FLYINIUM_Z",
  FLORIUM_Z = "FLORIUM_Z",
  ROCKIUM_Z = "ROCKIUM_Z",
  GHOSTIUM_Z = "GHOSTIUM_Z",
  FAIRIUM_Z = "FAIRIUM_Z",
  ICIUM_Z = "ICIUM_Z",
  FOSSILIUM_Z = "FOSSILIUM_Z",
  SOUNDIUM_Z = "SOUNDIUM_Z",
  ARTIFICIUM_Z = "ARTIFICIUM_Z",
  LIGHTIUM_Z = "LIGHTIUM_Z",
  WILDIUM_Z = "WILDIUM_Z",
  BABIUM_Z = "BABIUM_Z",
  AMORPHIUM_Z = "AMORPHIUM_Z"
}
...
export const ZCrystalSynergies: Record<
  (typeof ZCrystals)[number],
  Synergy
> = {
  [Item.NORMALIUM_Z]: Synergy.NORMAL,
  [Item.GRASSIUM_Z]: Synergy.GRASS,
  [Item.FIRIUM_Z]: Synergy.FIRE,
  [Item.WATERIUM_Z]: Synergy.WATER,
  [Item.ELECTRIUM_Z]: Synergy.ELECTRIC,
  [Item.FIGHTINIUM_Z]: Synergy.FIGHTING,
  [Item.PSYCHIUM_Z]: Synergy.PSYCHIC,
  [Item.DARKINIUM_Z]: Synergy.DARK,
  [Item.STEELIUM_Z]: Synergy.STEEL,
  [Item.GROUNDIUM_Z]: Synergy.GROUND,
  [Item.POISONIUM_Z]: Synergy.POISON,
  [Item.DRAGONIUM_Z]: Synergy.DRAGON,
  [Item.FIELDIUM_Z]: Synergy.FIELD,
  [Item.MONSTERIUM_Z]: Synergy.MONSTER,
  [Item.HUMANIUM_Z]: Synergy.HUMAN,
  [Item.AQUATINIUM_Z]: Synergy.AQUATIC,
  [Item.BUGINIUM_Z]: Synergy.BUG,
  [Item.FLYINIUM_Z]: Synergy.FLYING,
  [Item.FLORIUM_Z]: Synergy.FLORA,
  [Item.ROCKIUM_Z]: Synergy.ROCK,
  [Item.GHOSTIUM_Z]: Synergy.GHOST,
  [Item.FAIRIUM_Z]: Synergy.FAIRY,
  [Item.ICIUM_Z]: Synergy.ICE,
  [Item.FOSSILIUM_Z]: Synergy.FOSSIL,
  [Item.SOUNDIUM_Z]: Synergy.SOUND,
  [Item.ARTIFICIUM_Z]: Synergy.ARTIFICIAL,
  [Item.LIGHTIUM_Z]: Synergy.LIGHT,
  [Item.WILDIUM_Z]: Synergy.WILD,
  [Item.BABIUM_Z]: Synergy.BABY,
  [Item.AMORPHIUM_Z]: Synergy.AMORPHOUS
}