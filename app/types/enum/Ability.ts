...
export enum Ability {
  ...
  CHLOROPHYLL_HURRICANE = "CHLOROPHYLL_HURRICANE",
  GENESIS_SUPERNOVA = "GENESIS_SUPERNOVA",
  SUPREME_OVERLORD_SLASH = "SUPREME_OVERLORD_SLASH"
}

export const ZMoves = [
  Ability.NEVER_ENDING_NIGHTMARE,
  Ability.CHLOROPHYLL_HURRICANE,
  Ability.GENESIS_SUPERNOVA,
  Ability.SUPREME_OVERLORD_SLASH
]